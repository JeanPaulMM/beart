...
<html lang="en">
   ...
   <body class="main-layout position_head">
            ...
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="titlepage">
                     ...
                     <p>Descubre nuestra selección exclusiva de productos, cada uno diseñado para ofrecerte la mejor calidad y funcionalidad. Desde opciones personalizables hasta soluciones innovadoras, nuestra gama está pensada para satisfacer todas tus necesidades. Explora nuestra colección y encuentra el producto perfecto para ti, con detalles que destacan por su excelencia y atención al detalle.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="prods_box">
                     ...
                     <?php 
                     if($producto["id_producto"]==1 && isset($_SESSION["usuarioConectado"])){ ?>
                     <a type="button" class="read_more" href="personalizacion.php">Agregar al Carrito</a>
                     <?php 
                     }
                     elseif($producto["id_producto"]==1 && empty($_SESSION["usuarioConectado"])){ ?>
                     <a type="button" class="read_more" href="?cerrars=true">Agregar al Carrito</a>
                     <?php 
                     }
                     elseif($producto["id_producto"]<>1 && empty($_SESSION["usuarioConectado"])){ ?>
                     <a type="button" class="read_more vwpp" href="?cerrars=true">Ordenar via <svg style="margin-bottom:5px" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                     ...
                     <a type="button" class="read_more vwpp" href="https://www.instagram.com/creacionesbeart/">Ordenar via <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <input type="hidden" id="productId" name="prod">
                  </div>
                  <div class="modal-footer">
                     <button type="submit" class="btn btn-primary" value="confAgrCar">Confirmar</button>
                  </div>
               </div>
            </div>
         </form>
      ...
      <script>console.log($agrprod)</script>
