            ...
            <div class="row d_flex">
                        ...
                        <div class="carousel-item active">
                           <div class="container">
                              <div class="carousel-caption">
                                 <div class="text-bg">
                                    <div class="about_img">
                                       <figure><img src="images/referencialpz.png" alt="#"/></figure>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption">
                                 <div class="text-bg">
                                    <div class="about_img">
                                       <figure><img src="images/CAJA_LAPICERO.png" style="width:400px" alt="#"/></figure>
                                    </div>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="col-md-5">
                  <div class="titlepage">
                     ...
                     <p>Somos una empresa dedicada a la elaboración de artesanías en MDF, ofreciendo una amplia gama de productos únicos y creativos. Por medio de una maquina laser de alta precisión ofrecemos también el servicio de personalización cada artículo según las necesidades de nuestros clientes. Nuestro enfoque está en la calidad, el detalle y la innovación en cada diseño. Brindamos soluciones personalizadas para regalos, decoración y proyectos especiales.</p>
                  </div>
               </div>
            </div>
         </div>
