...
if(isset($_POST["tamanoL"])){
  $tamaño = $_POST["tamanoL"];
}
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../html/css/carpersstyle.css">
    <!-- Responsive-->
    <link rel="stylesheet" href="../../html/css/responsive.css">
    <!-- fevicon -->
    <link rel="icon" href="../../hmtl/images/fevicon.png" type="image/gif" />
  ...
  <body>
    <header id="headerperscar">
      <div class="header headerperscar" style="position:static !important">
              ...
              <nav class="navigation navbar navbar-expand-md navbar-dark ">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample04">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="carritocomprasview.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
    ...
    <section id="Carritopersbody">
      <form method="POST">
        <div class="container carritocont">
          <h2 class="titulocompra">Detalles</h2>
          <div class="container pequeñocontenedor">
            <div class="detalles">
              <input type="hidden" name="usuarioOn" value="<?php echo $iduser ?>">
              <input type="hidden" name="prod" value="<?php echo $producto ?>">
              <label class="labelcar">Mensaje Personalizado</label><br>
              <input class="fieldscar" type="text" name="mensajep" value="<?php if(isset($_POST["texto"])){ echo $texto; ?>" placeholder="<?php echo $texto; }?>" readonly><br>
              <label class="labelcar">Color</label><br>
              <input class="fieldscar" type="text" name="colorp" value="<?php if(isset($_POST["color"])){ echo $color; ?>" placeholder="<?php echo $color; }?>" readonly><br>
              <label class="labelcar">Fuente</label><br>
              <input class="fieldscar" type="text" name="fuentep" value="<?php if(isset($_POST["fuente"])){ echo $fuente; ?>" placeholder="<?php echo $fuente; }?>" readonly><br>
              <label class="labelcar">Tamaño</label><br>
              <input class="fieldscar" type="text" name="tamanoLp" value="<?php if(isset($_POST["tamanoL"])){ echo $tamaño; ?>" placeholder="<?php echo $tamaño; }?>" readonly><br>
              <label class="labelcar">Cantidad</label><br>
              <input id="cantidadp" class="fieldscar" type="number" name="cantp" placeholder="Cantidad a Comprar..." oninput="updateTotalCompra()" required><br>
            </div>
            <div class="imagen detallescompra">
              <img class="imgdetalle" src="../../html/images/visualizacion.jpeg">
              <div class="divtot">
                <p>Total:</p>
                <div class="total" style="display:flex; flex-direction: row;">
                  <p id="totalpago">0.00</p>
                  <p> COP</p>
                </div>
              </div>
              <div class="contboton">
                <button id="btnagrcar" class="btn btn-primary btnagrcar" type="submit" onclick="alertsubcar()">Agregar al carrito</button>
              </div>
            </div>
          </div>
        </div>
