<?php
require_once '../../Productos/Controller/prodsAdminController.php';
require_once '../../Productos/Model/prodsAdminModel.php';
...
<html lang="en">
    ...
    <body class="main-layout position_head">
        ...
        <section id="bodygestionprod">
            ...
            <div class="container add-button" style="margin-right:25px;">
            ...
            <div class="container overflow-y-auto overflow-hidden" style="height:60vh;">
                <table class="table table-light table-striped">
                    ...
                    foreach ($productos as $product) {
                        echo '<form id="gestionProds" method="post">';
                        ...
                        echo '<tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning" name="actualizar" onclick="actualizarProducto('.$product['id_producto'].')">
        ...
        <script src="../js/misjs/funcionproductos.js"></script>
